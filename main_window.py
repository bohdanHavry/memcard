...
layout_line4.addStretch(1) # розрив між кнопками робимо по можливості довшим
...
#frm_question = 'Як перекладається слово "Яблуко"?'
#frm_right = 'apple'
...
shuffle(radio_list)
# ми не знаємо, який це з радіобаттонів, але можемо покласти сюди правильну відповідь і запам'ятати це
answer = radio_list[0] 
